...
def get_special_qbs_file(filln, special_version=special_version):
    if special_version == 0:
        return h5_dir + '/recalculated_special_qbs/recalculated_special_qbs_v%i/recalculated_special_qbs_%i.h5' % (special_version, filln)
    else:
        return h5_dir + '/recalculated_special_qbs/recalculated_special_qbs_v%i/recalculated_special_qbs_v%i_%i.h5' % (special_version, special_version, filln)
...
def load_special_qbs(filln, special_version=special_version):
