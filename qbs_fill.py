...
def compute_qbs_fill(filln, use_dP):
    if use_dP:
        h5_file = 'recalculated_qbs_v%i_%i.h5' % (h5_storage.version, filln)
        if h5_file in os.listdir(h5_dir):
            return h5_storage.load_qbs(filln)
